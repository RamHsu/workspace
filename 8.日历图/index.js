(function() {
    ...
    function attachTitlesToDayRects(dayRects) {
        dayRects.append("title").text(function(s) {
            return s;
        });
    }
    ...
    function appendMonthPathsToYearGroups(yearGroups, cellSize) {
        ...
        function getPathDescriptionForMonth(month) {
            ...
            path =
                "M" +
                (thisMonthWeekOfYear + 1) * cellSize +
                "," +
                thisMonthDayOfWeek * cellSize + //  moveto #0
                "H" +
                thisMonthWeekOfYear * cellSize + //  lineto #1
                "V" +
                7 * cellSize + //  lineto #2
                "H" +
                nextMonthWeekOfYear * cellSize + //  lineto #3
                "V" +
                (nextMonthDayOfWeek + 1) * cellSize + //  lineto #4
                "H" +
                (nextMonthWeekOfYear + 1) * cellSize + //  lineto #5
                "V" +
                0 + //  lineto #6
                "H" +
                (thisMonthWeekOfYear + 1) * cellSize + //  lineto #7
                "Z"; //  close path
    ...
    function transformCsvData(csv) {
        ...
        function getDataObjectValue(dataObjects) {
            return (
                (dataObjects[0].Close - dataObjects[0].Open) /
                dataObjects[0].Open
            );
        }
